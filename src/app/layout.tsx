...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Тести ПДР 2026 Україна онлайн | Офіційні білети ГСЦ МВС',
    template: '%s | ПДР України 2026',
  },
  description:
    'Готуйтеся до іспиту ПДР 2026 онлайн! 100% відповідність базі ГСЦ МВС. Мобільний додаток, ШІ-аналітика помилок та симулятор іспиту. Почніть тестування безкоштовно!',
  keywords: [
    'тести ПДР онлайн',
    'білети ПДР 2026',
    'ПДД тесты онлайн',
  ...
  openGraph: {
    ...
    title: 'Тести ПДР 2026 Україна онлайн | Офіційні білети ГСЦ МВС',
    description:
      'Готуйтеся до іспиту ПДР 2026 онлайн! 100% відповідність базі ГСЦ МВС. Мобільний додаток, ШІ-аналітика помилок та симулятор іспиту.',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Тести ПДР 2026 Україна онлайн | Офіційні білети',
    description:
      'Офіційні питання ГСЦ МВС 2026, симулятор іспиту та ШІ-аналітика помилок. Готуйся онлайн!',
